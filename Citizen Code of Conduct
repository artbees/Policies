...
No weapons will be allowed at [COMMUNITY_NAME] events, community spaces, or in other spaces covered by the scope of this Code of Conduct. Weapons include but are not limited to guns, explosives (including fireworks), and large knives such as those used for hunting or display, as well as any other item used to cause injury or harm to others. Anyone seen in possession of one of these items will be asked to leave immediately, and will only be allowed to return without the weapon. Community members are further expected to comply with all state and local laws on this matter.
...
If you are subject to or witness unacceptable behaviour, or have any other concerns, please notify a community organizer as soon as possible. [CONTACT_INFO_HERE].
...
If you feel you have been falsely or unfairly accused of violating this Code of Conduct, you should notify [GOVERNING_BODY] with a concise description of your grievance. Your grievance will be handled by our existing governing policies. [LINK_TO_POLICY]

[NOTE: Every organisation's governing policies should dictate how you handle warnings and expulsions of community members. It is strongly recommended that you mention those policies here or in Section 7 and that you include a mechanism for addressing grievances.]
...
The Citizen Code of Conduct is distributed by [Artbees Community](https://community.artbees.co.uk) under a [Creative Commons Attribution-ShareAlike license](http://creativecommons.org/licenses/by-sa/3.0/). 
...
_Revision 2.0, adopted by the [Artbees](https://www.artbees.co.uk) board on 20 May 2014. Posted 18 March 2014._
